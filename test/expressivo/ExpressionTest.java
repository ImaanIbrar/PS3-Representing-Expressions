...
public class ExpressionTest {
	// Partition descriptions for addExpr method:
	// - Empty expression
	// - Expression with multiple variables
	// - Input expression as a subset of this expression
	// - Input expression equals this expression

	// Partition descriptions for multiplyExpr method:
	// - Empty expression
	...
	// Partition descriptions for addVariable method:
	// - Empty expression
	// - Expression without the input variable
	// - Expression with the input variable

	// Partition descriptions for multiplyVariable method:
	// - Empty expression
	// - Expression as a single value 1
	// - Expression without the input variable
	// - Expression with the input variable

	// Partition descriptions for addConstant method:
	// - Empty expression
	// - Expression containing a value
	// - Value: 0, greater than 0

	// Partition descriptions for appendCoefficient method:
	// - Empty expression
	// - Expression as the value 1
	// - Coefficient: 0, 1, greater than 1

	// Partition descriptions for toString method:
	// - Empty expression
	// - Expression with multiple variables and values

	// Partition descriptions for equals method:
	// - Reflexive, symmetric, and transitive equality
	// - Include tests for numbers correct to 5 decimal places

	// Partition descriptions for hashCode method:
	// - Include equal expressions with values correct to 5 decimal places
